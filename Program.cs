...
string[] names2 = new[] { "Kangaroo", "Gator", "Koala", "Dingo" };
...
int[] oneTwoTenNumbers = new int[] { 10, 20, 10 };
int[] oneTwoThreeTenNumbers = new int[] { 10, 20, 30, 10 };
int[] primeNumbers = new int[] { 2, 3, 5, 7, 11, 130, 170, 190, 230, 29 };
